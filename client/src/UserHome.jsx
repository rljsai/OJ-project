            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-base">
              <thead className="bg-gray-100 dark:bg-[#232336]">
                <tr>
                  ...
                  <th className="px-8 py-4 text-left text-base font-bold text-gray-500 dark:text-gray-300 uppercase tracking-wider">Acceptance</th>
                </tr>
              </thead>
              <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                {filteredProblems.length === 0 ? (
                  ...
                  filteredProblems.map((problem, idx) => (
                    <tr
                      key={problem.id}
                      className={`transition-colors hover:bg-gray-100 dark:hover:bg-[#A020F0]/10 ${
                        idx % 2 === 0
                    ...
                    >
                      ...
                      <td className="px-8 py-4 whitespace-nowrap text-base text-gray-700 dark:text-gray-300">{problem.acceptance}</td>
                    </tr>
                  ))
                )}
              </tbody>
